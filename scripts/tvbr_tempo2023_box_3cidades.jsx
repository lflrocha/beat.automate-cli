...
modelo = dados['modelo']
if (modelo == "Tarde") {
    var nome_arquivo = "projetos/tvbr_tempo2023_box_3cidades_tarde.aep"
} else {
    var nome_arquivo = "projetos/tvbr_tempo2023_box_3cidades.aep"
}
...
TrocarTexto(comp_cidade3, "temperatura_minima", cidade3['minima'] + 'º');
TrocarTexto(comp_cidade3, "temperatura_maxima", cidade3['maxima'] + 'º');
TrocarTexto(comp_cidade3, "probabilidade_chuva", cidade3['chuva'] + '%');
TrocarTexto(comp_cidade3, "umidade_minima", cidade3['umidade_min'] + '%');
TrocarTexto(comp_cidade3, "umidade_maxima", cidade3['umidade_max'] + '%');
...
var importOptions = new ImportOptions();
importOptions.file = new File(File(baseFolder + "arquivos/previsao-tempo/icones/amarelo/" + cidade3['icone'] + ".mov"));
var iconeImportado = app.project.importFile(importOptions);
comp_cidade3.layer('icone').replaceSource(iconeImportado, false);
