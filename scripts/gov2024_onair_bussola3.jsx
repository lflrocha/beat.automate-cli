...
var _io = new ImportOptions(File(baseFolder + "projetos/gov2024_onair_bussola3.aep"));
...
var compDados = app.project.item(5)
TrocarTexto(compDados, "t_programa", dados.programa_nome3)
TrocarTexto(compDados, "t_hora", dados.horario_texto3)

layer_aovivo = compDados.layer("b_ao_vivo")
if (dados.aovivo3 == false) {
  layer_aovivo.enabled = false;
}

programa_id = dados.programa_id3
programa_id = "video"
var importOptions = new ImportOptions();
importOptions.file = new File(File(baseFolder + "arquivos/canalgov/programas/" + programa_id + "_434x669.mp4"));
var videoImportado = app.project.importFile(importOptions);
