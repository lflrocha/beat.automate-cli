...
var _io = new ImportOptions(File(baseFolder + "projetos/gov2024_onair_aseguir.aep"));
...
importOptions.file = new File(File(baseFolder + "arquivos/canalgov/programas/" + programa_id + "_800x800.mp4"));
