...
var _io = new ImportOptions(File(baseFolder + "projetos/tvbr_esportes_placar.aep"));
...
var programa = "Stadium";
var campeonato = dados['campeonato'];
...
for (var i = 0; i < jogos.length; i += chunkSize) {
    ...
    for (var j = 1; j <= chunk.length; j++) {
      ...
      importOptionsA.file = new File(baseFolder + 'temp/'+ nomeTimeA + '.png');
      ...
      importOptionsB.file = new File(baseFolder + 'temp/' + nomeTimeB + '.png');
