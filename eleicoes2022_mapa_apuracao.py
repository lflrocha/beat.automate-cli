...
local = "DF"
ID = 'tvbr_eleicoes2022_mapa_apuracao'
tipo = ID
JSX = ROOT + 'scripts/tvbr_eleicoes2022_mapa_apuracao.jsx'
EXPORT = ROOT + 'export/tvbr_eleicoes2022_mapa_apuracao/'
DESTINO = local + '/TVBr_Eleicoes2022/'

titulo = "Mapa Apuração"
...
SAIDA = lib_dados.getTVBrEleicoes2022MapaApuracao(dados)
...
for render in renders:
    ...
    cmd = "cp " + arquivo + "  /Users/lflrocha/Sistemas/ebc.eleicoes2022/saida/MAPA_APURACAO.png"
    aux = os.system(cmd)
